...
import { fadeInUp, fadeIn, staggerContainer, scaleIn } from '../../../framer.js';
...
const Contact = () => {
  ...
  const validate = () => {
    ...
    else if (!/^\+?\d{7,15}$/.test(form.phone.replace(/\D/g, ''))) newErrors.phone = 'Enter a valid phone number.';
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      setSubmitting(false);
      setSuccess('Thank you! Your message has been sent. We will contact you soon.');
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                  ...
                  <input
                    type="text"
                    id="name"
                    className={`w-full px-4 py-2 border ${errors.name ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:outline-none focus:ring-2 focus:ring-gold`}
                ...
                <div>
                  ...
                  <input
                    type="email"
                    id="email"
                    className={`w-full px-4 py-2 border ${errors.email ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:outline-none focus:ring-2 focus:ring-gold`}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                  ...
                  <input
                    type="tel"
                    id="phone"
                    className={`w-full px-4 py-2 border ${errors.phone ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:outline-none focus:ring-2 focus:ring-gold`}
                ...
                <div>
                  ...
                  <select
                    id="eventType"
                    className={`w-full px-4 py-2 border ${errors.eventType ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:outline-none focus:ring-2 focus:ring-gold`}
                  ...
                  {errors.eventType && <span id="eventType-error" className="text-red-500 text-sm" role="alert">{errors.eventType}</span>}
                </div>
              </div>
              <div className="mb-6">
                ...
                <textarea
                  id="message"
                  rows={5}
                  className={`w-full px-4 py-2 border ${errors.message ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:outline-none focus:ring-2 focus:ring-gold`}
          ...
          >
            ...
            >
              <iframe
                ...
                src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=1%20Grafton%20StrRajghat,%20Varanashi,%20Near%20NK%20Pandey%20Petrol%20Pumpeet,%20Dublin,%20Ireland+(My%20Business%20Name)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"
                width="100%"
                height="100%"
